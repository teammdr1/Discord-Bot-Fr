...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    const categories = {
      ...
      '🎮・Roblox': [
        { name: '+code-promos', description: 'Affiche une liste de codes promotionnels Roblox.' },
        { name: '+robloxevent', description: 'Annonce un événement Roblox.' },
        { name: '+robloxquiz', description: 'Pose une question sur Roblox.' },
        { name: '+robloxstats', description: 'Affiche des statistiques sur Roblox.' },
        { name: '+robloxuser', description: 'Affiche des informations sur un utilisateur Roblox.' },
        { name: '+robloxgame', description: 'Affiche des informations sur un jeu Roblox.' },
        { name: '+robloxbadge', description: 'Affiche des informations sur un badge Roblox.' },
        { name: '+robloxavatar', description: 'Affiche l\'avatar d\'un utilisateur Roblox.' },
        { name: '+robloxgroup', description: 'Affiche des informations sur un groupe Roblox.' },
        { name: '+robloxgamepass', description: 'Affiche des informations sur un GamePass Roblox.' },
        { name: '+robloxbundle', description: 'Affiche des informations sur un bundle Roblox.' },
      ],
      '🧩・Jeux': [
