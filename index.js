...
// ===== NOUVEAU SYSTEME PANEL/CAPTCHA/ANTIRAID =====
client.captchaEnabled = false;
client.antiraidEnabled = false;

// charger les events
["captcha", "antiraid", "interactionButton"].forEach(file => {
    const event = require(`./src/events/${file}.js`);
